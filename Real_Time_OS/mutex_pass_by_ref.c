...
static LedStates_t ledState1 = {1, 0, 0, 1000, "message received 1."};

//red OFF, blue ON, green OFF, 1000mS delay, msg
static LedStates_t ledState2 = {0, 1, 0, 1000, "message received 2"};
...
void recvTask( void* NotUsed )
{
	...
	while(1)
	{
		...
		//SEGGER_SYSVIEW_PrintfHost("%c",nextCmd->message);
