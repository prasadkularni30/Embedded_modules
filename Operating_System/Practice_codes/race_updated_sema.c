...
int main()
{
  ...
  //
   ...
   unsigned long int i=0, j=0;//these iteration variables
     ...
     //final value of shared counter is 3existing shared-memory objecti for the given KEYi value
     // 
...
//     diagrams/slides 60,62  - idi will be returned and stored
  ...
  shma->count4 = 7353; //this is the initial value 
    ...
    printf("before value of shared counter is %d\n", shma->count); 
     printf("before value of shared counter1 is %d\n", shma->count1); 
     printf("before value of shared counter2 is %d\n", shma->count2); 
